    ...
    return (
        <div className="mt-5 py-5 ">
            <div className="text-center mb-4">
                <h2 className="font-bold text-[20px] lg:text-[30px] text-blue-800 ">What makes use different</h2>
            ...
            <div className="flex flex-col justify-center items-center lg:flex-row lg:space-x-5 lg:items-start">
                ...
                <div className="lg:w-96 text-justify space-y-3">
                    ...
                    <p className="">Our leading experts provide award winning, innovative, personalised medicine; specialising in mental health and orthopaedics.</p>
                    <p className="">Working together as a multidisciplinary team, our people are committed and passionate about patient health and wellbeing, supporting them through treatment, rehabilitation and recovery. </p>
                    <p> Welcome to Schoen Clinic, giving you access to world-class experts and care, when you need it most.</p>
